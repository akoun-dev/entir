      ...
      <div className="flex-1 overflow-y-auto py-4 px-3">
        ...
        {isOpen ? (
          <div className="px-3 py-2">
            ...
            >
              {getIconComponent("User", "h-5 w-5")}
              <span className="ml-3">Exemple Chatter</span>
            </NavLink>
          </div>
        ) : (
          <Tooltip>
            ...
            <TooltipContent side="right">Exemple Chatter</TooltipContent>
          </Tooltip>
        )}
