...
export const HrModuleCards: React.FC = () => {
  const modules = [
    ...
    },
    {
      id: 'organization',
      title: 'Organigramme',
      description: 'Visualisation de la structure hiérarchique',
      icon: <FolderTree className="h-10 w-10 p-2 rounded-full bg-amber-50 text-amber-500" />,
      route: '/hr/organization',
      summary: 'Visualisez et modifiez la structure hiérarchique de votre organisation.',
      stats: '1 organisation',
      badge: 'Visualisation',
      badgeVariant: 'outline',
      features: [
    ...
    },
    {
      ...
      icon: <ShieldAlert className="h-10 w-10 p-2 rounded-full bg-red-50 text-red-500" />,
      route: '/hr/roles',
      summary: 'Définissez les rôles et permissions par département.',
      stats: 'Nouveau',
      badge: 'Sécurité',
      badgeVariant: 'outline',
      features: [
