...
export const useDepartmentForm = () => {
  ...
  const [employees] = useState<Employee[]>([
    { id: '1', name: 'Jean Dupont', job_title: 'Directeur Général', department_id: '1', is_active: true },
    { id: '2', name: 'Marie Martin', job_title: 'Responsable RH', department_id: '2', is_active: true },
    { id: '3', name: 'Pierre Durand', job_title: 'Directeur Technique', department_id: '3', is_active: true },
    { id: '4', name: 'Sophie Lefebvre', job_title: 'Directrice Marketing', department_id: '5', is_active: true },
    { id: '5', name: 'Thomas Bernard', job_title: 'Directeur Financier', department_id: '4', is_active: true },
    { id: '6', name: 'Julie Moreau', job_title: 'Développeur Frontend', department_id: '3', is_active: true },
    { id: '7', name: 'Lucas Petit', job_title: 'Développeur Backend', department_id: '3', is_active: true },
    { id: '8', name: 'Emma Leroy', job_title: 'Chef de projet', department_id: '3', is_active: true },
    { id: '9', name: 'Hugo Roux', job_title: 'Comptable', department_id: '4', is_active: true },
    { id: '10', name: 'Camille Girard', job_title: 'Assistant RH', department_id: '2', is_active: true }
  ]);
  ...
  const handleSubmit = (e?: React.FormEvent) => {
    ...
    toast({
      title: "Succès",
      description: `Département ${isEditMode ? 'modifié' : 'créé'} avec succès !`,
      variant: "default"
    });
